...
- ## Частина 1 (Початок)
  ...
  - ### > [Стрілкові функції](https://youtu.be/FkP6uOrNDYI?si=yjzQONNFUCATYst3)
    - [В цілому про функції](https://www.w3schools.com/js/js_functions.asp) *
    - [Про стрілкові функції](https://www.w3schools.com/js/js_arrow_function.asp)*
    - [Параметри функцій / Аргументи](https://www.w3schools.com/js/js_function_parameters.asp) *
...
- ## Частина 2
  ...
  - ### > [Замикання](https://youtu.be/22exzMSyv2s?si=nckgXeEMBuRGClBU)
    - [Додатково](https://www.w3schools.com/js/js_function_closures.asp) *

  - ### > [Підняття](https://youtu.be/G3SmizIEOrI?si=a5-wo-AsPkBpXMWT)
    - [Додатково](https://www.w3schools.com/js/js_hoisting.asp)

  - ### > [Методи масивів](https://youtu.be/Y9ZP1tFNgqU?si=SeSKpQwUi-ZLO52I)
    - [Додатково](https://github.com/Dead-TR/-tch/blob/main/js/plan.md#-%D1%82%D0%B8%D0%BF%D0%B8-%D0%B4%D0%B0%D0%BD%D0%B8%D1%85) *
